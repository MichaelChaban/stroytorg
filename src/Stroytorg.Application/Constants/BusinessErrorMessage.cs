...
public static class BusinessErrorMessage
{
    ...
    public static string InvalidOrderMaterialAmount { get; } = "Material with Id {0} doesn't have this amount in stock";

    public static string InvalidMaterialsQuantity { get; } = "Bigger quantity was provided to order";

    public static string ExistingUserWithEmail { get; } = "User already exists with the provided email";
    ...
    public static string ExistingCategoryWithName { get; } = "Category already exists with the provided name";
    ...
    public static string ExistingMaterialsWithName { get; } = "Material already exists with the provided name";
