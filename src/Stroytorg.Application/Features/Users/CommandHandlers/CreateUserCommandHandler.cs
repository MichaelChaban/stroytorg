...
public class CreateUserCommandHandler(
    ...
    IRequestHandler<CreateUserCommand, BusinessResponse<User>>
{
    ...
    public async Task<BusinessResponse<User>> Handle(CreateUserCommand request, CancellationToken cancellationToken)
    {
